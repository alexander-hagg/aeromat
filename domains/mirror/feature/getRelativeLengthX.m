function [length, maxVertex, minVertex, maxVertexID, minVertexID] = getRelativeLengthX(mirror, d)
...
[maxVertex,maxVertexID] = max(mirror(:,1));
[minVertex,minVertexID] = min(mirror(:,1));
